...
# turn on observed climatology according to Chang 2006 
obs_clim       = Dict{String,Float64}("obs_teq"=>1.0) 

#include("HS.jl")
op_man         = Atmos_Spectral_Dynamics_Main(physics_params, obs_clim, end_day, spinup_day, L)

#### Finalize_Output!(op_man, output(t), output(time mean)) 
